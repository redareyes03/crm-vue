...
<template>
  <header class="bg-gray-800">
    <div class="max-w-6xl mx-auto py-10 flex justify-between items-center">
      ...
      >
          ...
          <span
            ...
            >
            <v-icon name="md-darkmode-twotone" v-if="darkMode" class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 center"/>
